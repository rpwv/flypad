        ...
        <form class="js_ajax-forms form-horizontal" data-url="admin/design.php">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <span class="help-block">
                        {__("The perfect size for your logo should be (width: 60px & height: 46px)")}
                    </span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    {/if}
                    <span class="help-block">
                        {__("The perfect size for your favicon should be (width: 196px & height: 196px)")}
                    </span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    {/if}
                    <span class="help-block">
                        {__("The perfect size for your og-image should be (width: 590px & height: 300px)")}
                    </span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    {/if}
                    <span class="help-block">
                        {__("The perfect size for your wallpaper should be (width: 4600px & height: 3000px)")}
                    </span>
                </div>
            </div>
